document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ---------------------------------------------------------
  // OBTENCIÓN DE SEDE Y ROL DESDE LOCAL STORAGE
  // ---------------------------------------------------------
  const sede = localStorage.getItem('sede') || 'pereira';
  const role = localStorage.getItem('role') || 'admin';

  // ---------------------------------------------------------
  // REDIRECCIÓN DEL LOGO SEGÚN EL ROL
  // ---------------------------------------------------------
  ...
  // ---------------------------------------------------------
  // AJUSTE DE VISIBILIDAD DEL SIDEBAR SEGÚN EL ROL
  // ---------------------------------------------------------
  ...
  if (role === 'patio') {
    // Para usuarios tipo "patio", ocultar los elementos que solo deben verse para admin.
    ...
    // Para admin, asegurar que se muestren
    elementosARestrigir.forEach(id => {
      const elem = document.getElementById(id);
      if (elem) {
        elem.style.display = '';
  ...
  // ---------------------------------------------------------
  // OCULTAR BOTÓN DE "AGREGAR REPORTE" PARA USUARIOS TIPO "PATIO"
  // ---------------------------------------------------------
  const agregarReporteBtn = document.getElementById('agregarReporte');
  if (role === 'patio' && agregarReporteBtn) {
    agregarReporteBtn.style.display = 'none';
  }

  // ---------------------------------------------------------
  // Resto de la lógica para obtener parámetros de la URL y cargar datos
  // ---------------------------------------------------------
  ...
  // ---------------------------------------------------------
  // LÓGICA PARA AGREGAR Y ELIMINAR REPORTES
  // ---------------------------------------------------------
  ...
  // ---------------------------------------------------------
  // ENVÍO DEL FORMULARIO PARA ACTUALIZAR EL DOCUMENTO
  // ---------------------------------------------------------
  const btnGuardar = document.getElementById('btnGuardar');
  if (btnGuardar) {
